...
public class ChinaLiveTitleAdapter extends FragmentStatePagerAdapter {
    private List<LiveChinasFragment> liveChinasFragments;
    private List<String> titles;
    public ChinaLiveTitleAdapter(FragmentManager fm, List<LiveChinasFragment> liveChinasFragments, List<String> titles) {
        super(fm);
