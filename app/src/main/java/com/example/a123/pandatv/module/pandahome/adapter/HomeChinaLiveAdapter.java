...
public class HomeChinaLiveAdapter extends BaseAdapter {
    private List<PandaHomeBean.DataBean.ChinaliveBean.ListBeanXX> pandaliveBeans;
    private LayoutInflater inflater;
    private Context context;
    public HomeChinaLiveAdapter(Context context, List<PandaHomeBean.DataBean.ChinaliveBean.ListBeanXX> pandaliveBeans){
    ...
    class HolderView{
        ...
        public void setDate(PandaHomeBean.DataBean.ChinaliveBean.ListBeanXX bean){
